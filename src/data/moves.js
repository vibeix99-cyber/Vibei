...
def({ id: 'draw_cut', name: 'Draw Cut', type: 'SLASH', category: 'physical', power: 30, accuracy: 100, pp: 30, priority: 1, contact: true, flags: ['slice', 'protect'],
...
def({ id: 'one_sword_slash', name: 'Single Blade', type: 'SLASH', category: 'physical', power: 45, accuracy: 100, pp: 30, contact: true, critStage: 1, flags: ['slice', 'protect'],
...
def({ id: 'sever_tendon', name: 'Tendon Sever', type: 'SLASH', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['slice', 'protect'],
...
def({ id: 'flying_slash', name: 'Flying Edge', type: 'SLASH', category: 'special', power: 50, accuracy: 100, pp: 15, flags: ['slice', 'protect'],
...
def({ id: 'thousand_cuts', name: 'Thousand Cuts', type: 'SLASH', category: 'physical', power: 15, accuracy: 95, pp: 20, contact: true, hits: [3, 5], flags: ['slice', 'protect'],
...
def({ id: 'three_sword_style', name: 'Oni Giri', type: 'SLASH', category: 'physical', power: 70, accuracy: 90, pp: 10, contact: true, critStage: 1, flags: ['slice', 'protect'],
...
def({ id: 'moonlit_reap', name: 'Moonlit Reap', type: 'SLASH', category: 'special', power: 70, accuracy: 90, pp: 10, flags: ['slice', 'protect'],
...
def({ id: 'black_blade', name: 'Black Blade', type: 'SLASH', category: 'physical', power: 90, accuracy: 90, pp: 5, contact: true, critStage: 1, flags: ['slice', 'protect'],
...
def({ id: 'quick_strike', name: 'Quick Strike', type: 'FIST', category: 'physical', power: 30, accuracy: 100, pp: 30, priority: 1, contact: true, flags: ['protect'],
...
def({ id: 'gum_gum_pistol', name: 'Gum-Gum Pistol', type: 'FIST', category: 'physical', power: 40, accuracy: 100, pp: 30, contact: true, flags: ['punch', 'protect'],
...
def({ id: 'shockwave_palm', name: 'Shockwave Palm', type: 'FIST', category: 'special', power: 50, accuracy: 100, pp: 15, flags: ['protect'],
...
def({ id: 'clutch', name: 'Clutch', type: 'FIST', category: 'physical', power: 55, accuracy: 100, pp: 15, contact: true, flags: ['protect'],
...
def({ id: 'gum_gum_gatling', name: 'Gum-Gum Gatling', type: 'FIST', category: 'physical', power: 20, accuracy: 90, pp: 15, contact: true, hits: [3, 5], flags: ['punch', 'protect'],
...
def({ id: 'meteor_knuckle', name: 'Meteor Knuckle', type: 'FIST', category: 'physical', power: 90, accuracy: 85, pp: 5, contact: true, recoil: 0.33, flags: ['punch', 'protect'],
...
def({ id: 'falling_star_fist', name: 'Falling Star Fist', type: 'FIST', category: 'physical', power: 105, accuracy: 90, pp: 5, contact: true, flags: ['punch', 'charge', 'protect'],
...
def({ id: 'black_gauntlet', name: 'Black Gauntlet', type: 'HAKI', category: 'physical', power: 75, accuracy: 95, pp: 10, contact: true, flags: ['punch', 'protect'],
...
def({ id: 'divine_departure', name: 'Divine Departure', type: 'HAKI', category: 'physical', power: 100, accuracy: 90, pp: 5, contact: true, flags: ['punch', 'protect'], recoil: 0.25,
...
def({ id: 'flame_lash', name: 'Flame Lash', type: 'FLAME', category: 'special', power: 50, accuracy: 100, pp: 20, flags: ['protect'],
...
def({ id: 'searing_kick', name: 'Searing Kick', type: 'FLAME', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['protect'],
...
def({ id: 'diable_jambe', name: 'Diable Jambe', type: 'FLAME', category: 'physical', power: 70, accuracy: 100, pp: 10, contact: true, flags: ['protect'],
  effects: [{ kind: 'status', value: 'brn', chance: 20, target: 'foe' }],
...
def({ id: 'fire_fist', name: 'Fire Fist', type: 'FLAME', category: 'special', power: 70, accuracy: 100, pp: 10, flags: ['protect'],
  effects: [{ kind: 'status', value: 'brn', chance: 20, target: 'foe' }],
...
def({ id: 'red_hawk', name: 'Red Hawk', type: 'FLAME', category: 'physical', power: 75, accuracy: 90, pp: 10, contact: true, flags: ['punch', 'protect'],
  effects: [{ kind: 'status', value: 'brn', chance: 20, target: 'foe' }],
...
def({ id: 'blaze_rush', name: 'Blaze Rush', type: 'FLAME', category: 'physical', power: 80, accuracy: 100, pp: 10, contact: true, recoil: 0.33, flags: ['protect'],
  effects: [{ kind: 'status', value: 'brn', chance: 10, target: 'foe' }],
...
def({ id: 'flare_nova', name: 'Flare Nova', type: 'FLAME', category: 'special', power: 100, accuracy: 90, pp: 5, flags: ['protect'],
...
def({ id: 'phoenix_dive', name: 'Phoenix Dive', type: 'FLAME', category: 'physical', power: 105, accuracy: 90, pp: 5, contact: true, flags: ['charge', 'protect'],
...
def({ id: 'frost_step', name: 'Frost Step', type: 'FROST', category: 'special', power: 30, accuracy: 100, pp: 25, priority: 1, flags: ['protect'],
...
def({ id: 'frostbite', name: 'Frostbite', type: 'FROST', category: 'special', power: 50, accuracy: 100, pp: 20, flags: ['protect'],
...
def({ id: 'rime_fist', name: 'Rime Fist', type: 'FROST', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['punch', 'protect'],
...
def({ id: 'ice_age', name: 'Ice Age', type: 'FROST', category: 'special', power: 70, accuracy: 90, pp: 10, flags: ['protect'],
...
def({ id: 'avalanche_drop', name: 'Avalanche', type: 'FROST', category: 'physical', power: 75, accuracy: 90, pp: 10, contact: true, flags: ['protect'],
...
def({ id: 'absolute_zero', name: 'Absolute Zero', type: 'FROST', category: 'special', power: 100, accuracy: 85, pp: 5, flags: ['protect'],
...
def({ id: 'aqua_step', name: 'Aqua Step', type: 'SEA', category: 'physical', power: 30, accuracy: 100, pp: 30, priority: 1, contact: true, flags: ['protect'],
...
def({ id: 'siphon_wave', name: 'Siphon Wave', type: 'SEA', category: 'special', power: 50, accuracy: 100, pp: 15, drain: 0.5, flags: ['pulse', 'protect'],
...
def({ id: 'shark_bite', name: 'Shark Bite', type: 'SEA', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['bite', 'protect'],
  effects: [{ kind: 'boost', stats: { def: -1 }, chance: 20, target: 'foe' }],
...
def({ id: 'fishman_karate', name: 'Fish-Man Karate', type: 'SEA', category: 'physical', power: 65, accuracy: 100, pp: 15, contact: true, flags: ['punch', 'protect'],
...
def({ id: 'abyss_pressure', name: 'Abyss Pressure', type: 'SEA', category: 'special', power: 70, accuracy: 90, pp: 10, flags: ['protect'],
...
def({ id: 'tenfold_tsunami', name: 'Tenfold Tsunami', type: 'SEA', category: 'special', power: 80, accuracy: 85, pp: 5, flags: ['protect'],
...
def({ id: 'spark_jab', name: 'Spark Jab', type: 'STORM', category: 'physical', power: 30, accuracy: 100, pp: 30, priority: 1, contact: true, flags: ['punch', 'protect'],
...
def({ id: 'arc_bolt', name: 'Arc Bolt', type: 'STORM', category: 'special', power: 50, accuracy: 100, pp: 20, flags: ['protect'],
...
def({ id: 'thunder_kick', name: 'Thunder Kick', type: 'STORM', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['protect'],
  effects: [{ kind: 'status', value: 'par', chance: 20, target: 'foe' }],
...
def({ id: 'chain_lightning', name: 'Chain Lightning', type: 'STORM', category: 'special', power: 20, accuracy: 95, pp: 15, hits: [2, 5], flags: ['protect'],
...
def({ id: 'thunderbolt_tempo', name: 'Thunderbolt Tempo', type: 'STORM', category: 'special', power: 70, accuracy: 100, pp: 10, flags: ['protect'],
  effects: [{ kind: 'status', value: 'par', chance: 20, target: 'foe' }],
...
def({ id: 'overcharge', name: 'Overcharge', type: 'STORM', category: 'physical', power: 80, accuracy: 100, pp: 10, contact: true, recoil: 0.33, flags: ['protect'],
...
def({ id: 'heavens_judgement', name: "Heaven's Judgement", type: 'STORM', category: 'special', power: 80, accuracy: 70, pp: 10, flags: ['protect'],
...
def({ id: 'el_thor', name: 'El Thor', type: 'STORM', category: 'special', power: 90, accuracy: 85, pp: 5, flags: ['protect'],
  effects: [{ kind: 'status', value: 'par', chance: 30, target: 'foe' }],
...
def({ id: 'mud_shot', name: 'Mud Shot', type: 'EARTH', category: 'special', power: 40, accuracy: 95, pp: 20, flags: ['protect'],
...
def({ id: 'boulder_toss', name: 'Boulder Toss', type: 'EARTH', category: 'physical', power: 50, accuracy: 95, pp: 20, flags: ['protect'],
...
def({ id: 'sand_lance', name: 'Sand Lance', type: 'EARTH', category: 'special', power: 50, accuracy: 100, pp: 15, flags: ['protect'],
...
def({ id: 'sables', name: 'Sables', type: 'EARTH', category: 'special', power: 60, accuracy: 100, pp: 10, flags: ['protect'],
...
def({ id: 'strata_spear', name: 'Strata Spear', type: 'EARTH', category: 'special', power: 100, accuracy: 95, pp: 5, flags: ['charge', 'protect'],
...
def({ id: 'feather_step', name: 'Feather Step', type: 'WIND', category: 'physical', power: 30, accuracy: 100, pp: 25, priority: 1, contact: true, flags: ['wind', 'protect'],
...
def({ id: 'slicing_gale', name: 'Slicing Gale', type: 'WIND', category: 'special', power: 50, accuracy: 100, pp: 20, critStage: 1, flags: ['wind', 'slice', 'protect'],
...
def({ id: 'tempest_kick', name: 'Tempest Kick', type: 'WIND', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['wind', 'protect'],
...
def({ id: 'cyclone_press', name: 'Cyclone Press', type: 'WIND', category: 'special', power: 75, accuracy: 85, pp: 10, flags: ['wind', 'protect'],
...
def({ id: 'heavens_gust', name: "Heaven's Gust", type: 'WIND', category: 'special', power: 80, accuracy: 80, pp: 5, flags: ['wind', 'protect'],
...
def({ id: 'shadow_clutch', name: 'Shadow Clutch', type: 'SHADOW', category: 'physical', power: 30, accuracy: 100, pp: 25, priority: 1, contact: true, flags: ['protect'],
...
def({ id: 'nightfall_bolt', name: 'Nightfall Bolt', type: 'SHADOW', category: 'special', power: 50, accuracy: 100, pp: 20, flags: ['protect'],
...
def({ id: 'umbral_claw', name: 'Umbral Claw', type: 'SHADOW', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['protect'],
  effects: [{ kind: 'volatile', value: 'flinch', chance: 20, target: 'foe' }],
...
def({ id: 'shadow_steal', name: 'Shadow Steal', type: 'SHADOW', category: 'special', power: 55, accuracy: 100, pp: 10, drain: 0.5, flags: ['protect'],
...
def({ id: 'abyssal_maw', name: 'Abyssal Maw', type: 'SHADOW', category: 'special', power: 70, accuracy: 90, pp: 10, flags: ['protect'],
  effects: [{ kind: 'volatile', value: 'flinch', chance: 20, target: 'foe' }],
...
def({ id: 'oblivion_rend', name: 'Oblivion Rend', type: 'SHADOW', category: 'physical', power: 90, accuracy: 85, pp: 5, contact: true, recoil: 0.25, flags: ['protect'],
...
def({ id: 'photon_dart', name: 'Photon Dart', type: 'LIGHT', category: 'special', power: 30, accuracy: 100, pp: 30, priority: 1, flags: ['protect'],
...
def({ id: 'flash_step', name: 'Flash Step', type: 'LIGHT', category: 'physical', power: 45, accuracy: 100, pp: 5, priority: 2, contact: true, flags: ['protect'],
...
def({ id: 'radiant_palm', name: 'Radiant Palm', type: 'LIGHT', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['protect'],
  effects: [{ kind: 'volatile', value: 'flinch', chance: 20, target: 'foe' }],
...
def({ id: 'yasakani', name: 'Yasakani Sacred Jewel', type: 'LIGHT', category: 'special', power: 75, accuracy: 100, pp: 5, flags: ['protect'],
...
def({ id: 'heavens_ray', name: "Heaven's Ray", type: 'LIGHT', category: 'special', power: 80, accuracy: 85, pp: 5, flags: ['protect'],
  effects: [{ kind: 'status', value: 'brn', chance: 10, target: 'foe' }],
...
def({ id: 'sunburst_lance', name: 'Sunburst Lance', type: 'LIGHT', category: 'special', power: 100, accuracy: 100, pp: 5, flags: ['charge', 'protect'],
...
def({ id: 'savage_bite', name: 'Savage Bite', type: 'BEAST', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['bite', 'protect'],
  effects: [{ kind: 'volatile', value: 'flinch', chance: 20, target: 'foe' }],
...
def({ id: 'wild_pulse', name: 'Wild Pulse', type: 'BEAST', category: 'special', power: 50, accuracy: 100, pp: 15, flags: ['pulse', 'protect'],
...
def({ id: 'pack_hunt', name: 'Pack Hunt', type: 'BEAST', category: 'physical', power: 20, accuracy: 95, pp: 20, contact: true, hits: [2, 5], flags: ['protect'],
...
def({ id: 'bloodlust', name: 'Bloodlust', type: 'BEAST', category: 'physical', power: 55, accuracy: 100, pp: 15, contact: true, drain: 0.5, flags: ['bite', 'protect'],
...
def({ id: 'beast_kings_roar', name: "Beast King's Roar", type: 'BEAST', category: 'special', power: 75, accuracy: 90, pp: 10, flags: ['sound', 'protect'],
  effects: [{ kind: 'volatile', value: 'flinch', chance: 20, target: 'foe' }],
...
def({ id: 'bolo_breath', name: 'Bolo Breath', type: 'BEAST', category: 'special', power: 80, accuracy: 90, pp: 5, flags: ['protect'],
  effects: [{ kind: 'status', value: 'brn', chance: 20, target: 'foe' }],
...
def({ id: 'rampage', name: 'Rampage', type: 'BEAST', category: 'physical', power: 90, accuracy: 100, pp: 5, contact: true, recoil: 0.33, flags: ['protect'],
...
def({ id: 'hair_trigger', name: 'Hair Trigger', type: 'MECHA', category: 'physical', power: 35, accuracy: 100, pp: 10, priority: 3, flags: ['bullet', 'protect'],
...
def({ id: 'scrap_sweep', name: 'Scrap Sweep', type: 'MECHA', category: 'physical', power: 40, accuracy: 100, pp: 20, contact: true, flags: ['protect'],
  effects: [{ kind: 'clearHazards' }],
...
def({ id: 'rivet_cannon', name: 'Rivet Cannon', type: 'MECHA', category: 'special', power: 50, accuracy: 100, pp: 20, flags: ['bullet', 'protect'],
  effects: [{ kind: 'volatile', value: 'flinch', chance: 20, target: 'foe' }],
...
def({ id: 'gear_strike', name: 'Gear Strike', type: 'MECHA', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['protect'],
...
def({ id: 'steel_meteor', name: 'Steel Meteor', type: 'MECHA', category: 'physical', power: 75, accuracy: 85, pp: 10, contact: true, flags: ['protect'],
...
def({ id: 'coup_de_vent', name: 'Coup de Vent', type: 'MECHA', category: 'special', power: 80, accuracy: 90, pp: 5, flags: ['recharge', 'protect'],
...
def({ id: 'overdrive_cannon', name: 'Overdrive Cannon', type: 'MECHA', category: 'special', power: 100, accuracy: 90, pp: 5, flags: ['bullet', 'protect'],
  effects: [{ kind: 'boost', stats: { spa: -2 }, target: 'self' }],
...
def({ id: 'mind_spike', name: 'Mind Spike', type: 'MIND', category: 'special', power: 50, accuracy: 100, pp: 20, flags: ['protect'],
  effects: [{ kind: 'boost', stats: { spd: -1 }, chance: 20, target: 'foe' }],
...
def({ id: 'pressure_point', name: 'Pressure Point', type: 'MIND', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['protect'],
  effects: [{ kind: 'boost', stats: { def: -1 }, chance: 20, target: 'foe' }],
...
def({ id: 'gamma_knife', name: 'Gamma Knife', type: 'MIND', category: 'special', power: 80, accuracy: 90, pp: 5, critStage: 1, flags: ['protect'],
...
def({ id: 'mind_break', name: 'Mind Break', type: 'MIND', category: 'special', power: 90, accuracy: 85, pp: 5, flags: ['protect'],
...
def({ id: 'venom_fang', name: 'Venom Fang', type: 'TOXIN', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['bite', 'protect'],
...
def({ id: 'corrosive_wave', name: 'Corrosive Wave', type: 'TOXIN', category: 'special', power: 50, accuracy: 100, pp: 20, flags: ['protect'],
  effects: [{ kind: 'boost', stats: { def: -1 }, chance: 20, target: 'foe' }],
...
def({ id: 'plague_cloud', name: 'Plague Cloud', type: 'TOXIN', category: 'special', power: 75, accuracy: 85, pp: 10, flags: ['protect'],
  effects: [{ kind: 'status', value: 'psn', chance: 30, target: 'foe' }],
...
def({ id: 'taiko_strike', name: 'Taiko Strike', type: 'SOUND', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['sound', 'protect'],
  effects: [{ kind: 'volatile', value: 'flinch', chance: 20, target: 'foe' }],
...
def({ id: 'echo_volley', name: 'Echo Volley', type: 'SOUND', category: 'special', power: 20, accuracy: 100, pp: 15, hits: [2, 5], flags: ['sound', 'protect'],
...
def({ id: 'screech_bomb', name: 'Screech Bomb', type: 'SOUND', category: 'special', power: 70, accuracy: 90, pp: 10, flags: ['sound', 'bullet', 'protect'],
  effects: [{ kind: 'boost', stats: { spd: -1 }, chance: 30, target: 'foe' }],
...
def({ id: 'final_requiem', name: 'Final Requiem', type: 'SOUND', category: 'special', power: 105, accuracy: 90, pp: 5, flags: ['sound', 'recharge', 'protect'],
...
def({ id: 'soul_leech', name: 'Soul Leech', type: 'SPIRIT', category: 'special', power: 50, accuracy: 100, pp: 15, drain: 0.5, flags: ['protect'],
...
def({ id: 'wandering_palm', name: 'Wandering Palm', type: 'SPIRIT', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['protect'],
  effects: [{ kind: 'volatile', value: 'flinch', chance: 20, target: 'foe' }],
...
def({ id: 'soul_solid', name: 'Soul Solid', type: 'SPIRIT', category: 'special', power: 65, accuracy: 100, pp: 10, flags: ['slice', 'sound', 'protect'],
  effects: [{ kind: 'boost', stats: { spd: -1 }, chance: 30, target: 'foe' }],
...
def({ id: 'spirit_bolt', name: 'Spirit Bolt', type: 'SPIRIT', category: 'special', power: 80, accuracy: 90, pp: 10, flags: ['bullet', 'protect'],
...
def({ id: 'soul_offering', name: 'Soul Offering', type: 'SPIRIT', category: 'special', power: 105, accuracy: 90, pp: 5, recoil: 0.5, flags: ['protect'],
...
def({ id: 'void_lance', name: 'Void Lance', type: 'VOID', category: 'special', power: 50, accuracy: 100, pp: 20, flags: ['protect'],
...
def({ id: 'erasure_fist', name: 'Erasure Fist', type: 'VOID', category: 'physical', power: 50, accuracy: 100, pp: 20, contact: true, flags: ['punch', 'protect'],
  effects: [{ kind: 'volatile', value: 'flinch', chance: 20, target: 'foe' }],
...
def({ id: 'finality', name: 'Finality', type: 'VOID', category: 'special', power: 100, accuracy: 100, pp: 5, priority: -4, flags: ['protect'],
...
def({ id: 'annihilation_ray', name: 'Annihilation Ray', type: 'VOID', category: 'special', power: 105, accuracy: 90, pp: 5, flags: ['recharge', 'protect'],
...
def({ id: 'singularity', name: 'Singularity', type: 'VOID', category: 'special', power: 110, accuracy: 85, pp: 5, flags: ['charge', 'protect'],
...
def({ id: 'cut_and_run', name: 'Cut and Run', type: 'SLASH', category: 'physical', power: 65, accuracy: 100, pp: 20, contact: true, flags: ['slice', 'protect', 'pivot'],
...
def({ id: 'hit_and_fade', name: 'Hit and Fade', type: 'FIST', category: 'physical', power: 65, accuracy: 100, pp: 20, contact: true, flags: ['punch', 'protect', 'pivot'],
...
def({ id: 'undertow', name: 'Undertow', type: 'SEA', category: 'special', power: 65, accuracy: 100, pp: 20, flags: ['protect', 'pivot'],
...
def({ id: 'volt_relay', name: 'Volt Relay', type: 'STORM', category: 'special', power: 65, accuracy: 100, pp: 20, flags: ['protect', 'pivot'],
...
def({ id: 'gale_exit', name: 'Gale Exit', type: 'WIND', category: 'physical', power: 65, accuracy: 100, pp: 20, contact: true, flags: ['wind', 'protect', 'pivot'],
...
def({ id: 'ember_break', name: 'Ember Break', type: 'FLAME', category: 'special', power: 65, accuracy: 100, pp: 20, flags: ['protect', 'pivot'],
...
def({ id: 'shade_slip', name: 'Shade Slip', type: 'SHADOW', category: 'physical', power: 65, accuracy: 100, pp: 20, contact: true, flags: ['protect', 'pivot'],
...
def({ id: 'scrap_launch', name: 'Scrap Launch', type: 'MECHA', category: 'special', power: 65, accuracy: 100, pp: 20, flags: ['bullet', 'protect', 'pivot'],
...
def({ id: 'mind_relay', name: 'Mind Relay', type: 'MIND', category: 'special', power: 65, accuracy: 100, pp: 20, flags: ['protect', 'pivot'],
...
def({ id: 'flash_relay', name: 'Flash Relay', type: 'LIGHT', category: 'special', power: 65, accuracy: 100, pp: 20, flags: ['protect', 'pivot'],
...
def({ id: 'soul_relay', name: 'Soul Relay', type: 'SPIRIT', category: 'special', power: 65, accuracy: 100, pp: 20, flags: ['protect', 'pivot'],
...
def({ id: 'run_down', name: 'Run Down', type: 'SHADOW', category: 'physical', power: 35, accuracy: 100, pp: 20, contact: true, flags: ['pursuit', 'protect'],
...
def({ id: 'hunters_mark', name: "Hunter's Mark", type: 'BEAST', category: 'physical', power: 35, accuracy: 100, pp: 20, contact: true, flags: ['bite', 'pursuit', 'protect'],
...
def({ id: 'tracking_round', name: 'Tracking Round', type: 'MECHA', category: 'special', power: 35, accuracy: 100, pp: 20, flags: ['bullet', 'pursuit', 'protect'],
...
def({ id: 'chasing_edge', name: 'Chasing Edge', type: 'SLASH', category: 'physical', power: 35, accuracy: 100, pp: 20, contact: true, flags: ['slice', 'pursuit', 'protect'],
...
def({ id: 'pinning_will', name: 'Pinning Will', type: 'HAKI', category: 'physical', power: 35, accuracy: 100, pp: 20, contact: true, flags: ['pursuit', 'protect'],
...
def({ id: 'heel_drop', name: 'Heel Drop', type: 'FIST', category: 'physical', power: 60, accuracy: 100, pp: 15, contact: true, flags: ['crush', 'protect'],
...
def({ id: 'pile_driver', name: 'Pile Driver', type: 'MECHA', category: 'physical', power: 65, accuracy: 95, pp: 15, contact: true, flags: ['crush', 'protect'],
...
def({ id: 'full_weight', name: 'Full Weight', type: 'BEAST', category: 'physical', power: 60, accuracy: 100, pp: 15, contact: true, flags: ['crush', 'protect'],
...
def({ id: 'haki_pierce', name: 'Haki Pierce', type: 'HAKI', category: 'physical', power: 55, accuracy: 100, pp: 15, contact: true, flags: ['bypassSub', 'protect'],
...
def({ id: 'phase_lance', name: 'Phase Lance', type: 'VOID', category: 'special', power: 55, accuracy: 100, pp: 15, flags: ['bypassSub', 'protect'],
...
def({ id: 'soul_reach', name: 'Soul Reach', type: 'SPIRIT', category: 'special', power: 50, accuracy: 100, pp: 20, flags: ['bypassSub', 'protect'],
...
def({ id: 'shrapnel_burst', name: 'Shrapnel Burst', type: 'MECHA', category: 'special', power: 55, accuracy: 100, pp: 15, flags: ['bullet', 'protect'],
  effects: [{ kind: 'hazard', value: 'caltrops', target: 'foeSide' }],
...
def({ id: 'barb_spray', name: 'Barb Spray', type: 'TOXIN', category: 'special', power: 55, accuracy: 100, pp: 15, flags: ['protect'],
  effects: [{ kind: 'hazard', value: 'barbs', target: 'foeSide' }],
...
def({ id: 'shatter_volley', name: 'Shatter Volley', type: 'FROST', category: 'special', power: 55, accuracy: 100, pp: 15, flags: ['protect'],
  effects: [{ kind: 'hazard', value: 'shards', target: 'foeSide' }],
...
def({ id: 'slick_tide', name: 'Slick Tide', type: 'SEA', category: 'special', power: 55, accuracy: 100, pp: 15, flags: ['protect'],
  effects: [{ kind: 'hazard', value: 'oilslick', target: 'foeSide' }],
...
def({ id: 'struggle', name: 'Struggle', type: '???', category: 'physical', power: 40, accuracy: null, pp: 1,
